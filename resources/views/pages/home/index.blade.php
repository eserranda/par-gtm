            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded position-relative overflow-hidden">
                        <img src="{{ asset('home_assets') }}/img/about-2.png" class="img-fluid rounded w-100"
                            alt="">

                        <div class="" style="position: absolute; top: -15px; right: -15px;">
                            <img src="{{ asset('home_assets') }}/img/about-3.png" class="img-fluid"
                                style="width: 150px; height: 150px; opacity: 0.7;" alt="">
                        </div>
                        <div class=""
                            style="position: absolute; top: -20px; left: 10px; transform: rotate(90deg);">
                            <img src="{{ asset('home_assets') }}/img/about-4.png" class="img-fluid"
                                style="width: 100px; height: 150px; opacity: 0.9;" alt="">
                        </div>
                        <div class="rounded-bottom">
                            <img src="{{ asset('home_assets') }}/img/about-5.jpg"
            ...
            <div class="owl-carousel blog-carousel wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-item p-4">
                    <div class="blog-img mb-4">
                        <img src="{{ asset('home_assets') }}/img/service-1.jpg" class="img-fluid w-100 rounded"
                            alt="">
                    ...
                    <p class="mb-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore
                        aut aliquam
                        suscipit error corporis accusamus labore....
                    </p>
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('home_assets') }}/img/testimonial-1.jpg" class="img-fluid rounded-circle"
                ...
                <div class="blog-item p-4">
                    <div class="blog-img mb-4">
                        <img src="{{ asset('home_assets') }}/img/service-2.jpg" class="img-fluid w-100 rounded"
                            alt="">
                        <div class="blog-title">
                    ...
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('home_assets') }}/img/testimonial-2.jpg" class="img-fluid rounded-circle"
                            style="width: 60px; height: 60px;" alt="">
                        <div class="ms-3">
                            <h5>Admin</h5>
                            <p class="mb-0">October 9, 2025</p>
                ...
                <div class="blog-item p-4">
                    <div class="blog-img mb-4">
                        <img src="{{ asset('home_assets') }}/img/service-3.jpg" class="img-fluid w-100 rounded"
                            alt="">
                        <div class="blog-title">
                            <a href="#" class="btn">Dividend Stocks</a>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('home_assets') }}/img/testimonial-3.jpg" class="img-fluid rounded-circle"
                            style="width: 60px; height: 60px;" alt="">
                        <div class="ms-3">
                            <h5>Admin</h5>
                            <p class="mb-0">October 9, 2025</p>
                ...
                <div class="blog-item p-4">
                    <div class="blog-img mb-4">
                        <img src="{{ asset('home_assets') }}/img/service-4.jpg" class="img-fluid w-100 rounded"
                            alt="">
                        <div class="blog-title">
                            <a href="#" class="btn">Non-Dividend Stocks</a>
                        </div>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded">
                        <img src="{{ asset('home_assets') }}/img/about-2.png" class="img-fluid w-100"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-img">
                        <img src="{{ asset('home_assets') }}/img/testimonial-1.jpg" class="img-fluid"
                            alt="Image">
                    </div>
                    <div class="testimonial-text">
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Facilis blanditiis
                            excepturi quisquam temporibus voluptatum reprehenderit culpa, quasi corrupti
                            laborum
                            accusamus.
                        </p>
                    </div>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-img">
                        <img src="{{ asset('home_assets') }}/img/testimonial-2.jpg" class="img-fluid"
                            alt="Image">
                    </div>
                    <div class="testimonial-text">
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                ...
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-img">
                        <img src="{{ asset('home_assets') }}/img/testimonial-3.jpg" class="img-fluid"
                            alt="Image">
                    </div>
                    <div class="testimonial-text">
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="footer-item">
                        <a href="index.html" class="p-0">
                            <h4 class="text-white"><i class="fas fa-search-dollar me-3"></i>Stocker
                            </h4>
                            <!-- <img src="{{ asset('home_assets') }}/img/logo.png" alt="Logo"> -->
                        </a>
                        <p class="mb-4">Dolor amet sit justo amet elitr clita ipsum elitr est.Lorem
                            ipsum dolor sit
