...
<head>
    ...
    <title>Jemaat Rantekamase</title>
    ...
    <link href="{{ asset('jemaatsatu_assets') }}/css/bootstrap.min.css" rel="stylesheet">

    <link href="{{ asset('jemaatsatu_assets') }}/css/bootstrap-icons.css" rel="stylesheet">

    <link href="{{ asset('jemaatsatu_assets') }}/css/templatemo-topic-listing.css" rel="stylesheet">
    <!--
...
<body id="top">
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="/">Sinode</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#jemaat">Jemaat</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#pengurus">Pengurus PAR</a>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">Jemaat Rantekamase</h1>

                        <h6 class="text-center">Klasis Sumarorong</h6>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="custom-block bg-white shadow-lg">
                            <div class="d-flex">
                                <div>
                                    ...
                                    <ul>
                                        <li class="mb-2">
                                            Melayani anak dan remaja untuk menanamkan nilai-nilai iman
                                            Kristen berdasarkan Alkitab
                                        </li>
                                        <li class="mb-2">
                                            Memperlengkapi anak dan remaja agar menerima dan menghayati
                                            panggilan Allah sehingga mengaku “YESUS KRISTUS ITULAH TUHAN DAN JURUSELAMAT
                                        </li>
                                        <li class="mb-2">
                                            Mendidik Anak dan remaja agar menjadi generasi yang takut
                                            akan Tuhan
                                        </li>
                                        <li class="mb-2">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-block custom-block-overlay">
                            <div class="d-flex flex-column h-100">
                                {{-- <img src="{{ asset('jemaatsatu_assets') }}/images/businesswoman-using-tablet-analysis.jpg"
                                    class="custom-block-image img-fluid" alt=""> --}}

                                <div class="custom-block-overlay-text d-flex">
                                    <div>
                                        <h5 class="text-white mb-2">Misi</h5>

                                        <p class="text-white">Membangun iman dan karakter anak-anak serta remaja melalui
                                            kegiatan
                                            yang inspiratif dan edukatif, serta menyediakan lingkungan yang aman dan
                                            mendukung
                                            untuk pertumbuhan rohani.</p>
        ...
        <section class="faq-section section-padding" id="pengurus">
            <div class="container">
                <div class="row">

                    <div class="col-lg-6 col-12">
                        <h2 class="mb-4">Pengurus PA Jemaat Rantekamase</h2>
                    </div>
                    ...
                    {{-- <div class="col-lg-5 col-12">
                        <img src="{{ asset('jemaatsatu_assets') }}/images/faq_graphic.jpg" class="img-fluid"
                            alt="FAQs">
                    </div>
        ...
        <section class="faq-section section-padding" id="jemaat">
            <div class="container">
                <div class="row">

                    <div class="col-lg-6 col-12">
                        <h2 class="mb-4">Daftar Jemaat</h2>
                    </div>
    ...
    <!-- JAVASCRIPT FILES -->
    <script src="{{ asset('jemaatsatu_assets') }}/js/jquery.min.js"></script>
    <script src="{{ asset('jemaatsatu_assets') }}/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('jemaatsatu_assets') }}/js/jquery.sticky.js"></script>
    <script src="{{ asset('jemaatsatu_assets') }}/js/click-scroll.js"></script>
    <script src="{{ asset('jemaatsatu_assets') }}/js/custom.js"></script>
